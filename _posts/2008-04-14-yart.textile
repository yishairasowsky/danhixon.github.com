...
<p>Great!  Now we have a functional Cookbook and Recipe model.  But now we realize that we need to make recipes belong to cookbooks.  We'll do that in <a href="/2008/4/15/rails-lesson-2-the-console">Rails Lesson #2.</a></p>
